...
const AppBar = require('material-ui/lib/app-bar');  // require components
const IconButton = require('material-ui/lib/icon-button'); // require components
const NavigationClose = require('material-ui/lib/svg-icons/navigation/close');  //require svg-icons
...
Note that there are two main categories of objects that may be required
  1. components
    * stored in material-ui/src and its sub-folders
    * require as ```require('material-ui/lib/...')```
    * for a full path list, see material-ui/src/index.js
    
  2. svg-icons
    * stored in material-ui/src/svg-icons and its sub-folders
    * require as ```require('material-ui/lib/svg-icons/...')```
    * for a full path list, see material-ui/src/svg-icons/index.js
